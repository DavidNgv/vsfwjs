...
(function() {
  ...
  vsfw.app = function() {
    var a, app, apply_helpers, client, client_bundle_simple, client_bundled, context, func, helpers, io, options, partials, postrenders, real_root, request_socket, root, route, socket_session, use_middleware, verb, vsfw_prefix, vsfw_used, wrap_middleware, ws_handlers, _fn, _i, _j, _len, _len1, _ref2, _ref3;
    ...
    context.use = function() {
      var k, use, v, vsfw_middleware, _k, _len2;
      vsfw_middleware = {
  ...
  vsfw.run = function() {
    ...
    express_ready = function() {
      ...
      return log("vsfw " + vsfw.version + " \"" + codename + "\" orchestrating the show");
    };
    if (host) {
